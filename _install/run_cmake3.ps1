...
$env:PATH = "C:\Windows\system32;C:\Windows;C:\BuildTools\VC\Tools\MSVC\14.44.35207\bin\Hostx64\x64;C:\BuildTools\Common7\Tools;C:\BuildTools\MSBuild\Current\Bin\amd64;C:\BuildTools\Common7\IDE\CommonExtensions\Microsoft\CMake\Ninja;" + [Environment]::GetEnvironmentVariable("PATH","Machine")
